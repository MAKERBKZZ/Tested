...
local InventoryWatcher = _G.InventoryWatcher or loadstring(game:HttpGet("https://raw.githubusercontent.com/MAKERBKZZ/Tested/refs/heads/main/utils/fishit/inventdetect.lua"))()
