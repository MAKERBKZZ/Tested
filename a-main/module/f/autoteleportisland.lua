...
local STATIC_ISLAND_CFRAMES = {
    ...
    ["Bawah Air Terjun"] = CFrame.new(-2083, 6, 3658),
    ["Atas Air Terjun"]  = CFrame.new(-2145, 53, 3621),
    ["Dalam Goa"]        = CFrame.new(-2166, 2, 3640),
    ["Tebing Laut"]      = CFrame.new(-2184, 25, 3591),
    ["NOOB"] = CFrame.new(-580.46, 8.13, 154.66),
    ["Tengah"] = CFrame.new(1009, 18, 5063),
    ["Tepi"]   = CFrame.new(1069, 2, 5046),
    ["Depan Board"]      = CFrame.new(-3738, -135, -1010),
    ["Belakang Patung"]  = CFrame.new(-3694, -135, -888),
    ["Bawah Jembatan"] = CFrame.new(-64, 3, 2781),
    ["Atas Jembatan"]  = CFrame.new(-86, 18, 2814),
    ...
    ["Ancient.J Floral"] =  CFrame.new(1369.512451, -41.965446, -609.125000, 0.933992, 0.00000000, 0.357293, -0.00000000, 1.000000, -0.00000000, -0.357293, 0.00000000, 0.933992),
    ...
    ["Ancient.J Secret"] =  CFrame.new(1480.191528, -22.375002, -664.851318, -0.011113, -0.00000010, -0.999938, 0.00000004, 1.000000, -0.00000010, 0.999938, -0.00000005, -0.011113),
    ["M.Hallowen Spot1"] =  CFrame.new(2189.558105, 6.875396, 3052.168701, -0.027969, -0.00000002, -0.999609, 0.00000000, 1.000000, -0.00000002, 0.999609, -0.00000000, -0.027969),
    ["M.Hallowen Spot2"] =  CFrame.new(2118.023193, 80.331253, 3264.388672, -0.921990, -0.00000002, -0.387213, -0.00000003, 1.000000, 0.00000002, 0.387213, 0.00000003, -0.921990),
    ["M.Hallowen Halowbay"] =  CFrame.new(1787.929199, 7.867562, 3038.612793, 0.991792, 0.00000002, 0.127865, -0.00000002, 1.000000, 0.00000002, -0.127865, -0.00000002, 0.991792),
...
local ISLAND_MAPPING = {
    ...
    ["Bawah Air Terjun"]  = "Bawah Air Terjun",
    ["Atas Air Terjun"]   = "Atas Air Terjun",
    ["Dalam Goa"]         = "Dalam Goa",
    ["Tebing Laut"]       = "Tebing Laut",
    ["NOOB"]              = "NOOB",
    ["Tengah"]            = "Tengah",
    ["Tepi"]              = "Tepi",
    ["Depan Board"]       = "Depan Board",
    ["Belakang Patung"]   = "Belakang Patung",
    ["Bawah Jembatan"]    = "Bawah Jembatan",
    ["Atas Jembatan"]     = "Atas Jembatan",
    ...
    ["Ancient.J Floral Bait"] = "Ancient.J Floral",
    ["M.Hallowen Spot1"]         = "M.Hallowen Spot1",
    ["M.Hallowen Spot2"]         = "M.Hallowen Spot2",
    ["M.Hallowen Halowbay"]         = "M.Hallowen Halowbay",
